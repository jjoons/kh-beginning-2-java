...
public class 김밥천국 {
	...
	public void ex1() {
		...
		// 주문한 음식
		String 음식 = 주방장("김치찌개");
		System.out.println(음식 + "을 맛있게 먹는다");
	}
...
메소드 리턴 타입
  ...
  자료형이 리턴 타입으로 오면 반환(return)해 주는 값(메소드 자료형과 동일한 값)이
  반드시 있어야 하고 void는 반환 값이 없다.
